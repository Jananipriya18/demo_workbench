...
import { MusicListComponent } from './playlist-list.component'; // Adjust the import path
import { of } from 'rxjs';
...
describe('MusicListComponent', () => {
    ...
    beforeEach(waitForAsync(() => {
        ...
        mockMusicRecordService = jasmine.createSpyObj<MusicRecordService>('MusicRecordService', ['getPlaylists', 'deletePlaylist'] as any);
